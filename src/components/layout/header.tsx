...
const NAV_LINKS = [
  ...
  { href: '/import', label: 'Paste a post', icon: Wand2 },
...
export function Header({
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/60 backdrop-blur-2xl supports-[backdrop-filter]:bg-background/40 dark:border-white/5 pt-[env(safe-area-inset-top)]">
