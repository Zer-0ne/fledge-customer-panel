    ...
    return (
      <>
        ...
        <div
          ...
          className="relative z-10 h-1 w-full cursor-pointer overflow-hidden rounded-full bg-muted"
          onClick={handleClick}
...
export function NotificationCenter() {
  ...
  return (
    <div className="w-full max-w-sm" ref={rootRef}>
      <LiquidGlassCard className="gap-3.5 rounded-3xl border border-border bg-gradient-to-br from-card to-muted p-4 shadow-xl">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 overflow-hidden">
            <h3 className="overflow-hidden text-ellipsis whitespace-nowrap font-semibold text-lg text-card-foreground">
              Glow
            </h3>
          ...
          <div className="mt-1 flex items-center justify-between">
            <div className="flex items-center justify-center gap-2">
              <LiquidButton
                ...
                className="size-10 rounded-full bg-transparent text-foreground transition-colors hover:bg-muted"
                size="icon"
                variant="ghost"
              >
              ...
              <LiquidButton
                ...
                className="size-11 rounded-full bg-transparent text-foreground transition-colors hover:bg-muted"
