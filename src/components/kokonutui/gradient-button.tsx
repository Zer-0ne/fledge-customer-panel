...
const gradientColors: Record<ColorVariant, GradientColors> = {
  emerald: {
    dark: {
      border: "from-[#336C4F] via-background to-[#0D6437]",
      overlay: "from-[#347B52]/40 via-background to-[#0D6437]/30",
      accent: "from-[#87F6B7]/10 via-background to-[#17362A]/50",
  ...
  purple: {
    dark: {
      border: "from-[#6B46C1] via-background to-[#553C9A]",
      overlay: "from-[#7E22CE]/40 via-background to-[#6B46C1]/30",
      accent: "from-[#E9D8FD]/10 via-background to-[#44337A]/50",
  ...
  orange: {
    dark: {
      border: "from-[#C05621] via-background to-[#9C4221]",
      overlay: "from-[#DD6B20]/40 via-background to-[#C05621]/30",
      accent: "from-[#FED7AA]/10 via-background to-[#7B341E]/50",
