  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-border/60 bg-card px-3 py-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="text-xs text-muted-foreground">{relative || 'just now'}</p>
      </div>
      <span
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3 min-h-[180px]">
          ...
          {isEmpty && (
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="mt-1 text-xs text-muted-foreground max-w-[260px]">When someone views your request, their name and time will appear here.</p>
            </div>
          )}
...
/**
 * Owner-only entry row: "N views" — tappable to open ViewersSheet.
